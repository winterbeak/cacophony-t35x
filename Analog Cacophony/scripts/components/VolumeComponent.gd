...
func _ready() -> void:
	...
	guitar_c.position = Vector2(Constants.LIGHT_DISTANCE_HORIZ, Constants.LIGHT_CENTER_Y)
	guitar_g.position = Vector2(Constants.LIGHT_DISTANCE_HORIZ, Constants.LIGHT_CENTER_Y)
